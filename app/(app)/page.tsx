...
export default function Home() {
  ...
  const { data: session } = useSession(); // email e userId disponíveis aqui
  ...
  useEffect(() => {
    ...
    // Atualiza quando a aba volta ao foco ou quando storage muda (outra aba)
    function onFocus() {
      refresh();
    }
  ...
  return (
    <section className="space-y-8">
      {/* Header simples com usuário e sair */}
